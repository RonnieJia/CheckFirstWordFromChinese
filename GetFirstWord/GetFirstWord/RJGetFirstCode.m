...
+ (NSString *)getFirstWord:(NSString *)chinese {
    char firstWord = pinyinFirstLetter([chinese characterAtIndex:0]);
    NSString *first = [[NSString stringWithFormat:@"%c",firstWord] uppercaseString];
    return first;
}
